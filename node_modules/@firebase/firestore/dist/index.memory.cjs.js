...
e) {
    ...
    return e.__extends(n, t), n.prototype.at = function(t, e) {
        if (this.Et(t), me(null != e.transformResults), !this.Rt.Tt(t)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
...
var ft, lt, pt = function(t, e) {
    ...
    return t.Wt = function(e) {
        ...
        get: function() {
            if (null === this.Bt) {
                ...
                t.Y() || this.Bt.push(new Tt(t)), this.Bt.push(new Tt(b.X(), "asc" /* ASCENDING */)); else {
     ...
     */    return e.__extends(n, t), n.create = function(t, e, r) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Et(t, r) : "in" /* IN */ === e ? new At(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new It(t, r) : new n(t, e, r);
 ...
 */ var oe = {
    ...
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.Ii = function(t, e) {
        ...
        if ("targetChange" in t) {
            ...
            var A = t.filter;
            A.targetId;
            var I = A.count || 0, N = new Dt(I), T = A.targetId;
            e = new $t(T, N);
        }
        return e;
...
var Se = function() {
    ...
    return t.prototype.Tr = function(t, e) {
        return this.wr.add(e), Re.resolve();
    }, t.prototype.jn = function(t, e) {
        return Re.resolve(this.wr.getEntries(e));
    }, t;
}(), qe = /** @class */ function() {
    function t() {
        this.index = {};
 ...
 * limitations under the License.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Oe(t) {
 ...
 */ var Pe = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Rr = t, this.ir = e, this.Ar = n, this.op = r, this.Pr = i, this.Vr = new Se, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.yr && (this.clearTimeout(), this.Vr.reject(new c(h.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.kr = new Le(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.Wr = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.Br(), this.Dr ? [ 3 /*break*/ , 2 ] : (this.Dr = !0, (n = he.nt().window) && n.removeEventListener("visibilitychange", this.Or), 
                    [ 4 /*yield*/ , this.Qr(t) ]);
    ...
    t.prototype.jr = function(t) {
                ...
                return e.__awaiter(n, void 0, void 0, (function() {
                    ...
                    return e.__generator(this, (function(e) {
                        switch (e.label) {
                          ...
                          case 2:
                            if (!Oe(n = e.sent())) throw r.resolve(), n;
        ...
        var e = this, n = this.Sr.then((function() {
            return e.$r = !0, t().catch((function(t) {
                ...
                throw e.Nr = t, e.$r = !1, de("INTERNAL UNHANDLED ERROR: ", t.stack || t.message || ""), 
                t;
            })).then((function(t) {
                return e.$r = !1, t;
            }));
    ...
    t.prototype.dr = function(t, e, n) {
        ...
        var i = Pe.pr(this, t, e, n, (function(t) {
            return r.Gr(t);
        }));
 ...
 */
function xe(t, e) {
    if (de("AsyncQueue", e + ": " + t), Oe(t)) return new c(h.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
Fe.ih = -1, Fe.nh = 1048576, Fe.rh = 41943040, Fe.eh = 10, Fe.sh = 1e3, Fe.hh = new Fe(Fe.rh, Fe.eh, Fe.sh), 
Fe.DISABLED = new Fe(Fe.ih, 0, 0);
...
var je = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.lh = m.min(), this.Dn = t._h(n), this.fh = t.dh(), this.wh = t.Th(), this.Eh = new De(this.fh, this.Dn, this.persistence.mh()), 
        this.oh.Ih(this.Eh)
                  ...
                  case 0:
                    return n = this.Dn, r = this.Eh, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(e) {
                        ...
                        return o.Dn.Ah(e).next((function(s) {
                            ...
                            // MutationQueue.
                            r = new De(o.fh, n, o.persistence.mh()), n.Ah(e);
                        })).next((function(t) {
    ...
    t.Wh = function(t, e, n) {
        ...
        return me(e.resumeToken.rt() > 0), 0 === t.resumeToken.rt() || (e.Te.C() - t.Te.C() >= this.Xh || n.ws.size + n.Ts.size + n.Es.size > 0);
                  ...
                  case 0:
                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(e) {
                        return Re.forEach(t, (function(t) {
                            return Re.forEach(t.Kn, (function(n) {
                                return c.persistence.zh.Zh(e, t.targetId, n);
                            })).next((function() {
                                return Re.forEach(t.zn, (function(n) {
    ...
    t.prototype.no = function(t) {
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.wh.ro(n, t).next((function(i) {
                ...
                r = i, Re.resolve(r)) : e.wh.ho(n).next((function(i) {
                    return r = new Rt(t, i, 0 /* Listen */ , n.Qh), e.wh.oo(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
    ...
    t.prototype.ro = function(t, e) {
        var n = this.uh.get(e);
        return void 0 !== n ? Re.resolve(this.ah.get(n)) : this.wh.ro(t, e);
    }, 
    /**
    ...
    t.prototype.ao = function(t, e) {
        ...
        return this.persistence.runTransaction("Release target", i, (function(t) {
            return e ? Re.resolve() : n.persistence.zh.removeTarget(t, r);
        })).then((function() {
...
var Be = /** @class */ function() {
    function t() {
        ...
        this.do = new qt(ze.wo), 
        // A set of outstanding references to a document sorted by target id.
        this.To = new qt(ze.Eo)
    ...
    t.prototype.Ao = function(t) {
        var e = this, n = E.EMPTY, r = new ze(n, t), i = new ze(n, t + 1), o = [];
        ...
        var e = E.EMPTY, n = new ze(e, t), r = new ze(e, t + 1), i = zt();
        return this.To.Ge([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.po = function(t) {
        var e = new ze(t, 0), n = this.do.Ke(e);
 ...
 */ var ln = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        We("Blob.fromBase64String", arguments, 1), Xe("Blob.fromBase64String", "string", 1, e), 
        fn();
        try {
        ...
        return We("Blob.toBase64", arguments, 0), fn(), this.vo.toBase64();
    }, t.prototype.toUint8Array = function() {
        return We("Blob.toUint8Array", arguments, 0), cn(), this.vo.toUint8Array();
    }, t.prototype.toString = function() {
...
var dn = new RegExp("[~\\*/\\[\\]]"), yn = function(t) {
    ...
    return e.__extends(n, t), n.prototype.Ci = function(t) {
        var e = new Tn({
            Fo: 3 /* Argument */ ,
            methodName: this.Do
        }, t.ii, t.serializer), n = Dn(this.ko, e), r = new Y(t.serializer, n);
        return new $(t.path, r);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(yn), bn = /** @class */ function() {
    function t(t, e) {
        if (We("GeoPoint", arguments, 2), Xe("GeoPoint", "number", 1, t), Xe("GeoPoint", "number", 2, e), 
...
/** A "context" object passed around while parsing user data. */ var Tn = /** @class */ function() {
    ...
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Nn(this.Fo) && En.test(t)) throw this.No('Document fields cannot begin and end with "__"');
    }, t;
}(), Rn = /** @class */ function() {
    function t(t, e) {
    ...
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.zo = function(t, e, n) {
        ...
        if (n) {
            for (var u = [], a = 0, f = n; a < f.length; a++) {
                var l = f[a], p = void 0;
                if (l instanceof pn) p = l.So; else {
    ...
    /** Parse update data from a list of field/value arguments. */ t.prototype.Xo = function(t, e, n, r) {
        var i = this.Ko(1 /* Update */ , t), o = [ Ln(t, e) ], s = [ n ];
        ...
        for (var a = [], f = new ht, l = o.length - 1; l >= 0; --l) if (!qn(a, o[l])) {
        ...
        var m = new K(a);
        return new In(f.gt(), m, i.fieldTransforms);
    }, 
    ...
    t.prototype.Jo = function(t, e, n) {
        return void 0 === n && (n = !1), Dn(e, this.Ko(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }, t;
}();
 ...
 */
function Dn(t, e) {
    if (Vn(t)) return Sn("Unsupported field value:", e, t), kn(t, e);
    if (t instanceof yn) 
    ...
    return function(t, e) {
        ...
        if (!Nn(e.Fo)) throw e.No(t.Do + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.No("Unsupported field value: " + nn(t));
    }(t, e);
}
...
function Vn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof v || t instanceof bn || t instanceof ln || t instanceof mr || t instanceof yn);
}
 ...
 */ function Ln(t, e) {
    if (e instanceof pn) return e.So;
 ...
 */ var Un = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.na = 0, this.ra = null, this.stream = null, this.kr = new Le(t, e)
        /**
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.state = t, [ 4 /*yield*/ , this.listener.wa(n) ];
    ...
    n, r, i, o) {
        ...
        this.au = function(t, e, n) {
            var r = ge(t);
            return new On(e, r.sa, r.credentials, r.serializer, n);
        }(this.$a, r, {
            ...
            var r = ge(t);
            return new Pn(e, r.sa, r.credentials, r.serializer, n);
        }(this.$a, r, {
    ...
    t.prototype.Fu = function(t) {
        ...
        var n = this, r = this.Za.shift(), i = Te.from(r, t, e, this._u.lastStreamToken);
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            return e.__generator(this, (function(e) {
                ...
                return kt(t.code) ? [ 2 /*return*/ , (pe("RemoteStore", "RemoteStore error before completed handshake; resetting stream token: ", this._u.lastStreamToken), 
                this._u.lastStreamToken = T.ht, this.Ja.qh(T.ht).catch(Ge)) ] : [ 2 /*return*/ ];
            }));
        }));
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                ...
                // logic kick in.
                return kt(r = t.code) && r !== h.ABORTED ? (n = this.Za.shift(), [ 2 /*return*/ , (this._u.ua(), 
    ...
    function t() {
        this.Gu = new Gn, this.Hu = {}, this.gu = null, this.Qa = null, this.Xn = null;
    }
    return t.prototype.Ku = function(t) {
        ...
        return this.Gu = new Gn, Promise.resolve();
    ...
    function t(t, e, n, r) {
        this.Rr = t, this.Ac = e, this.updateFunction = n, this.Vr = r, this.Pc = 5, this.kr = new Le(this.Rr, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.Vc = function() {
        ...
        try {
            ...
            return !R(e) && e.catch && e.then ? e : (this.Vr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
    ...
    n, r, i) {
        ...
        /**
             ...
             */
        this.kc = new Map, this.Oc = new Be, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.qc = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Mc = new Map, this.xc = Ue.Ir(), this.onlineState = "Unknown" /* Unknown */;
    }
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return i = e.sent(), o = new Wn(t, i.lo), s = o.uc(i.documents), u = Zt.fs(n, r && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.fc(s, 
                    /* updateLimboDocuments= */ this.Bc, u), this.Wc(n, a.Tc), h = new Hn(t, n, o), 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , this.Ja.yh(t) ];

                  case 2:
                    return r = e.sent(), this.Sc.Ku(r.batchId), this.Gc(r.batchId, n), [ 4 /*yield*/ , this.Hc(r.bh) ];
                ...
                switch (e.label) {
                  ...
                  case 2:
                    ...
                    t.as.forEach((function(t, e) {
                        ...
                        me(t.ws.size + t.Ts.size + t.Es.size <= 1), t.ws.size > 0 ? n.vc = !0 : t.Ts.size > 0 ? me(n.vc) : t.Es.size > 0 && (me(n.vc), 
                        n.vc = !1));
                    })), [ 4 /*yield*/ , this.Hc(n, t) ];
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.Sc.Xu(t, "rejected", n), r = this.kc.get(t), (i = r && r.key) ? (o = (o = new St(E.N)).Re(i, new yt(i, m.min())), 
                    s = zt().add(i), u = new Yt(m.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new qt(_e), o, s), [ 4 /*yield*/ , this.xh(u) ]) : [ 3 /*break*/ , 2 ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.Ja.kh() ];

                  case 2:
                    return -1 === (n = e.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.Mc.get(n) || []).push(t), 
                    this.Mc.set(n, r), [ 3 /*break*/ , 4 ]);
    ...
    t.prototype.Yc = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof zn ? (this.Oc.Zh(i.key, t), this.sl(i)) : i instanceof Qn ? (pe("SyncEngine", "Document no longer in limbo: " + i.key), 
    ...
    t.prototype.zc = function() {
        for (;this.$c.length > 0 && this.Lc.size < this.Cc; ) {
            ...
            this.kc.set(e, new Xn(t)), this.Lc = this.Lc.Re(t, e), this.Ac.listen(new Rt(gt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , Ve.er));
        }
    }, 
    // Visible for testing
                    ...
                    return r = [], i = [], o = [], this.Fc.forEach((function(e, u) {
                        o.push(Promise.resolve().then((function() {
                            ...
                            if (s.Wc(u.targetId, o.Tc), o.snapshot) {
                                ...
                                var a = ke.Yn(u.targetId, o.snapshot);
                                i.push(a);
                            }
                        })));
    ...
    function t(t) {
        this.gu = t, this.ol = new Ie((function(t) {
            return t.canonicalId();
    ...
    return t.prototype.listen = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    if (n = t.query, r = !1, (i = this.ol.get(n)) || (r = !0, i = new Zn), !r) return [ 3 /*break*/ , 4 ];
                    e.label = 1;
    ...
    return t.prototype.yl = function(t) {
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.pl = this.pl.add(new ze(a.key, i)), this.Fn.Tr(t, a.key.path.k());
        }
        return Re.resolve(o);
    }, t.prototype.$h = function(t, e) {
        return Re.resolve(this.bl(e));
    }, t.prototype.so = function(t, e) {
        var n = e + 1, r = this.vl(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Re.resolve(this.Dn.length > i ? this.Dn[i] : null);
    }, t.prototype.kh = function() {
        return Re.resolve(0 === this.Dn.length ? -1 : this.Vl - 1);
    }, t.prototype.Ah = function(t) {
        return Re.resolve(this.Dn.slice());
        ...
        // because it precedes all other segments in an ordered traversal.
                E.et(i) || (i = i.child(""));
        var o = new ze(new E(i), 0), s = new qt(_e);
        ...
        var n = new ze(e, 0), r = this.pl.Ke(n);
        return Re.resolve(e.isEqual(r && r.key));
    }, t.prototype.Fh = function(t) {
        return this.Dn.length, Re.resolve();
    }, 
    /**
...
nr.Ll = /** @class */ function(t) {
    ...
    t.prototype.kn = function(t, e) {
        this.Ml();
        var n = this.bh.get(e);
        return void 0 !== n ? Re.resolve(n) : this.xl(t, e);
    }, 
    /**
...
var rr = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.jl = new Be, this.targetCount = 0, this.Gl = Ue.mr();
    }
    return t.prototype.js = function(t, e) {
        ...
        return Re.resolve(this.Wl);
    }, t.prototype.ho = function(t) {
        return this.highestTargetId = this.Gl.next(), Re.resolve(this.highestTargetId);
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.Gl = new Ue(e), this.highestTargetId = e), t.sequenceNumber > this.Wl && (this.Wl = t.sequenceNumber);
    }, t.prototype.oo = function(t, e) {
        return this.Kl(e), this.targetCount += 1, Re.resolve();
    }, t.prototype.jh = function(t, e) {
        return this.Kl(e), Re.resolve();
        ...
        return this.jl.mo(e, n), Re.resolve();
        ...
        return this.jl.Ao(e), Re.resolve();
    }, t.prototype.co = function(t, e) {
        var n = this.jl.Vo(e);
        return Re.resolve(n);
    }, t.prototype.po = function(t, e) {
        return Re.resolve(this.jl.po(e));
    }, t;
}(), ir = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.Zl = {}, this.t_ = new Ve(0), this.e_ = !1, this.e_ = !0, this.zh = t(this), 
        this.wh = new rr(this), this.Fn = new Me, this.Cn = new nr(this.Fn, (function(t) {
            return e.zh.s_(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.Zl[t.s()];
        return e || (e = new er(this.Fn, this.zh), this.Zl[t.s()] = e), e;
        ...
        return Re.Sn(Object.values(this.Zl).map((function(n) {
            return function() {
                return n.po(t, e);
            };
        })));
    ...
    return t.f_ = function(e) {
        ...
        return this.l_.Zh(n, e), this.d_.delete(n), Re.resolve();
    }, t.prototype.to = function(t, e, n) {
        return this.l_.to(n, e), this.d_.add(n), Re.resolve();
    }, t.prototype.Cl = function(t, e) {
        return this.d_.add(e), Re.resolve();
        ...
        // Remove newly orphaned documents.
                return Re.forEach(this.d_, (function(r) {
        ...
        var n = this;
        return Re.Sn([ function() {
            return Re.resolve(n.l_.po(e));
        }, function() {
     ...
     */
    r) {
        this.platform = t, this.b_ = e, this.credentials = n, this.Rr = r, this.clientId = we.cn()
        /**
    ...
    t.prototype.v_ = function() {
        if (this.Rr.Mr) throw new c(h.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.Bu = function(t) {
        return this.Rr.Hr(), pe("FirestoreClient", "Credential Changed. Current user: " + t.uid), 
        this.gu.Bu(t);
    }, 
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    return this.v_(), n = new Se, [ 4 /*yield*/ , this.Rr.enqueue((function() {
                        return e.__awaiter(r, void 0, void 0, (function() {
                            var r, i, o;
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.Ja.io(t) ];
                    ...
                    return this.v_(), n = new Se, [ 4 /*yield*/ , this.Rr.enqueue((function() {
                        return e.__awaiter(r, void 0, void 0, (function() {
                            ...
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.Ja.uo(t, 
                                    /* usePreviousResults= */ !0) ];

                                  case 1:
                                    return r = e.sent(), i = new Wn(t, r.lo), o = i.uc(r.documents), s = i.fc(o, 
...
var fr = /** @class */ function() {
    ...
    return t.prototype.U_ = function(t) {
        ...
        return new bn(x(t.latitude), x(t.longitude));
    }, t.prototype.H_ = function(t) {
        var e = this;
        ...
        var e = w.G(t);
        me(ae(e));
        var n = new Ae(e.get(1), e.get(3)), r = new E(e.L(5));
        ...
        new mr(r, this.firestore, this.converter);
    }, t;
}(), lr = Fe.ih, pr = /** @class */ function() {
    function t(t) {
        var e, n;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new c(h.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else Ze("settings", "non-empty string", "host", t.host), this.host = t.host, Ke("settings", "boolean", "ssl", t.ssl), 
        this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (on("settings", t, [ "host", "ssl", "credentials", "timestampsInSnapshots", "cacheSizeBytes", "experimentalForceLongPolling" ]), 
        Ke("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        Ke("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), 
        ...
        Ke("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Fe.rh; else {
            if (t.cacheSizeBytes !== lr && t.cacheSizeBytes < Fe.nh) throw new c(h.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Fe.nh);
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        Ke("settings", "boolean", "experimentalForceLongPolling", t.experimentalForceLongPolling), 
    ...
    function t(n, r, i) {
        var o = this;
        if (void 0 === i && (i = new ur), this.z_ = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.Y_ = new Ce, this.INTERNAL = {
            delete: function() {
            ...
            this.Zo = new Ae(u.projectId, u.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.tf = "[DEFAULT]", this.ef = new l;
        }
        this.sf = i, this.if = new pr({}), this.nf = new Rn(this.Zo);
    }
    return t.prototype.settings = function(t) {
        We("Firestore.settings", arguments, 1), Xe("Firestore.settings", "object", 1, t);
        var e = new pr(t);
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(r) {
                ...
                return t = new Se, [ 2 /*return*/ , (this.Y_.xr((function() {
                    return e.__awaiter(n, void 0, void 0, (function() {
                        var n, r;
                        return e.__generator(this, (function(e) {
                            switch (e.label) {
        ...
        if (this.X_(), cr(t)) return this.cf(t);
        ...
        var n = this.af();
        return this.J_ = new ar(he.nt(), n, this.ef, this.Y_), this.J_.start(t, e);
    }, t.Z_ = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new c(h.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        return We("Firestore.collection", arguments, 1), Xe("Firestore.collection", "non-empty string", 1, t), 
        this.X_(), new Ar(w.G(t), this);
    }, t.prototype.doc = function(t) {
        return We("Firestore.doc", arguments, 1), Xe("Firestore.doc", "non-empty string", 1, t), 
        this.X_(), mr.lf(w.G(t), this);
    }, t.prototype.collectionGroup = function(t) {
        if (We("Firestore.collectionGroup", arguments, 1), Xe("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.X_(), new br(new gt(w.H, t), this);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return We("Firestore.runTransaction", arguments, 1), Xe("Firestore.runTransaction", "function", 1, t), 
        this.X_().transaction((function(n) {
            return t(new yr(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.X_(), new vr(this);
        ...
        switch (We("Firestore.setLogLevel", arguments, 1), Xe("Firestore.setLogLevel", "non-empty string", 1, t), 
        t) {
          case "debug":
            le(r.LogLevel.DEBUG);
            break;
    ...
    return t.prototype.get = function(t) {
        ...
        var n = Rr("Transaction.get", t, this.ff);
        return this.df.Ma([ n.ta ]).then((function(t) {
            if (!t || 1 !== t.length) return ve();
            var r = t[0];
            if (r instanceof yt) return new wr(e.ff, n.ta, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.wf);
            if (r instanceof dt) return new wr(e.ff, n.ta, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.wf);
            throw ve();
        }));
        ...
        var r = Rr("Transaction.set", t, this.ff);
        n = Ir("Transaction.set", n);
        var i = kr(r.wf, e, "Transaction.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.ff.nf.zo(s, o, n.mergeFields) : this.ff.nf.Ho(s, o);
        return this.df.set(r.ta, u), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof pn ? (Je("Transaction.update", arguments, 3), 
        r = Rr("Transaction.update", t, this.ff), i = this.ff.nf.Xo("Transaction.update", e, n, o)) : (We("Transaction.update", arguments, 2), 
        r = Rr("Transaction.update", t, this.ff), i = this.ff.nf.Yo("Transaction.update", e)), 
        this.df.update(r.ta, i), this;
    }, t.prototype.delete = function(t) {
        We("Transaction.delete", arguments, 1);
        var e = Rr("Transaction.delete", t, this.ff);
    ...
    return t.prototype.set = function(t, e, n) {
        He("WriteBatch.set", arguments, 2, 3), this.mf();
        var r = Rr("WriteBatch.set", t, this.ff);
        n = Ir("WriteBatch.set", n);
        var i = kr(r.wf, e, "WriteBatch.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.ff.nf.zo(s, o, n.mergeFields) : this.ff.nf.Ho(s, o);
        return this.Tf = this.Tf.concat(u.Mo(r.ta, et.dt())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.mf(), "string" == typeof e || e instanceof pn ? (Je("WriteBatch.update", arguments, 3), 
        r = Rr("WriteBatch.update", t, this.ff), i = this.ff.nf.Xo("WriteBatch.update", e, n, o)) : (We("WriteBatch.update", arguments, 2), 
        r = Rr("WriteBatch.update", t, this.ff), i = this.ff.nf.Yo("WriteBatch.update", e)), 
        this.Tf = this.Tf.concat(i.Mo(r.ta, et.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        We("WriteBatch.delete", arguments, 1), this.mf();
        var e = Rr("WriteBatch.delete", t, this.ff);
        return this.Tf = this.Tf.concat(new st(e.ta, et.dt())), this;
    }, t.prototype.commit = function() {
    ...
    return t.lf = function(e, n, r) {
        ...
        get: function() {
            return new Ar(this.ta.path.k(), this.firestore, this.wf);
        },
        enumerable: !0,
        configurable: !0
        ...
        if (We("DocumentReference.collection", arguments, 1), Xe("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new c(h.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = w.G(t);
        return new Ar(this.ta.path.child(e), this.firestore);
    }, t.prototype.isEqual = function(e) {
        ...
        He("DocumentReference.set", arguments, 1, 2), e = Ir("DocumentReference.set", e);
        var n = kr(this.wf, t, "DocumentReference.set"), r = n[0], i = n[1], o = e.merge || e.mergeFields ? this.firestore.nf.zo(i, r, e.mergeFields) : this.firestore.nf.Ho(i, r);
        return this.J_.write(o.Mo(this.ta, et.dt()));
    }, t.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof pn ? (Je("DocumentReference.update", arguments, 2), 
        n = this.firestore.nf.Xo("DocumentReference.update", t, e, r)) : (We("DocumentReference.update", arguments, 1), 
        n = this.firestore.nf.Yo("DocumentReference.update", t)), this.J_.write(n.Mo(this.ta, et.exists(!0)));
    }, t.prototype.delete = function() {
        return We("DocumentReference.delete", arguments, 0), this.J_.write([ new st(this.ta, et.dt()) ]);
        ...
        Ke("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++);
        var o = {
            includeMetadataChanges: r.includeMetadataChanges
        };
        return cr(t[i]) ? n = t[i] : (Xe("DocumentReference.onSnapshot", "function", i, t[i]), 
        ...
        var i = new hr({
            next: function(t) {
                if (e.next) {
                    ...
                    e.next(new wr(n.firestore, n.ta, r, t.fromCache, t.hasPendingWrites, n.wf));
                }
            },
            error: r
        ...
        var e = this;
        return He("DocumentReference.get", arguments, 0, 1), Tr("DocumentReference.get", t), 
        new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.X_().O_(e.ta).then((function(t) {
                n(new wr(e.firestore, e.ta, t, 
                /*fromCache=*/ !0, t instanceof dt && t.At, e.wf));
            }), r) : e.Rf(n, r, t);
        }));
    ...
    return t.prototype.data = function(t) {
        if (He("DocumentSnapshot.data", arguments, 0, 1), t = Nr("DocumentSnapshot.data", t), 
        this.Af) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.wf) {
                var e = new _r(this.ff, this.ta, this.Af, this.Pf, this.Vf);
                return this.wf.fromFirestore(e, t);
            }
            return new fr(this.ff, this.ff._f(), t.serverTimestamps, 
            /* converter= */ void 0).U_(this.Af.kt());
        }
    }, t.prototype.get = function(t, e) {
        if (He("DocumentSnapshot.get", arguments, 1, 2), e = Nr("DocumentSnapshot.get", e), 
        this.Af) {
            var n = this.Af.data().field(Ln("DocumentSnapshot.get", t));
            if (null !== n) return new fr(this.ff, this.ff._f(), e.serverTimestamps, this.wf).U_(n);
        }
    }, Object.defineProperty(t.prototype, "id", {
        get: function() {
            return this.ta.path.q();
        ...
        get: function() {
            return new mr(this.ta, this.ff, this.wf);
        },
        enumerable: !0,
        configurable: !0
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        return this.bf(p), new t(this.pf.Ht(p), this.firestore, this.wf);
    }, t.prototype.orderBy = function(e, n) {
        var r;
        if (He("Query.orderBy", arguments, 1, 2), Ye("Query.orderBy", "non-empty string", 2, n), 
    ...
    t.prototype.Cf = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.pf.orderBy; r < i.length; r++) {
            ...
            if (o.field.Y()) n.push(j(this.firestore.Zo, t.key)); else {
                ...
                if (k(s)) throw new c(h.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + o.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === s) {
                    var u = o.field.j();
    ...
    t.prototype.Df = function(t, e, n) {
        ...
        Ke("Query.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++), cr(t[i]) ? n = t[i] : (Xe("Query.onSnapshot", "function", i, t[i]), Ye("Query.onSnapshot", "function", i + 1, t[i + 1]), 
        ...
        var i = new hr({
            next: function(t) {
                e.next && e.next(new Er(n.firestore, n.pf, t, n.wf));
            },
            error: r
        ...
        var e = this;
        return He("Query.get", arguments, 0, 1), Tr("Query.get", t), this.Ff(this.pf), new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.X_().q_(e.pf).then((function(t) {
                n(new Er(e.firestore, e.pf, t, e.wf));
            }), r) : e.Rf(n, r, t);
        }));
    }, t.prototype.Rf = function(t, e, n) {
        var r = this.If({
    ...
    function t(t, e, n, r) {
        ...
        this.metadata = new gr(n.hasPendingWrites, n.fromCache);
    }
    return Object.defineProperty(t.prototype, "docs", {
        ...
        get: function() {
            return new br(this.$f, this.ff, this.wf);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (on("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), Ke("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        ...
        function(t, e, n, r) {
            if (n.ss.M()) {
                ...
                return n.docChanges.map((function(e) {
                    var o = new _r(t, e.doc.key, e.doc, n.fromCache, n.ns.has(e.doc.key), r);
                    return e.doc, {
                        type: "added",
                        doc: o,
                        oldIndex: -1,
            ...
            return n.docChanges.filter((function(t) {
                ...
                var i = new _r(t, e.doc.key, e.doc, n.fromCache, n.ns.has(e.doc.key), r), s = -1, u = -1;
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return new _r(this.ff, t.key, t, this.metadata.fromCache, this.Lf.ns.has(t.key), this.wf);
    }, t;
}(), Ar = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
    ...
    return e.__extends(n, t), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.M() ? null : new mr(new E(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = we.cn()), Xe("CollectionReference.doc", "non-empty string", 1, t), 
        "" === t) throw new c(h.INVALID_ARGUMENT, "Document path must be a non-empty string");
        var e = w.G(t);
        return mr.lf(this.pf.path.child(e), this.firestore, this.wf);
    }, n.prototype.add = function(t) {
        We("CollectionReference.add", arguments, 1), Xe("CollectionReference.add", "object", 1, this.wf ? this.wf.toFirestore(t) : t);
        var e = this.doc();
...
function Ir(t, e) {
    ...
    if (on(t, e, [ "merge", "mergeFields" ]), Ke(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
...
function Nr(t, e) {
    return void 0 === e ? {} : (on(t, e, [ "serverTimestamps" ]), $e(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function Tr(t, e) {
    Ye(t, "object", 1, e), e && (on(t, e, [ "source" ]), $e(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
var Sr = Vr(dr, "Use firebase.firestore() instead."), Lr = Vr(yr, "Use firebase.firestore().runTransaction() instead."), Mr = Vr(vr, "Use firebase.firestore().batch() instead."), qr = Vr(mr, "Use firebase.firestore().doc() instead."), Ur = Vr(wr), Or = Vr(_r), Pr = Vr(br), Cr = Vr(Er), xr = Vr(Ar, "Use firebase.firestore().collection() instead."), Fr = Vr(/** @class */ function() {
    function t() {}
    return t.delete = function() {
        return Qe("FieldValue.delete", arguments), new vn;
    }, t.serverTimestamp = function() {
        return Qe("FieldValue.serverTimestamp", arguments), new mn;
    }, t.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
                return Je("FieldValue.arrayUnion", arguments, 1), new gn(t);
    }, t.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
                return Je("FieldValue.arrayRemove", arguments, 1), new wn(t);
    }, t.increment = function(t) {
        return Xe("FieldValue.increment", "number", 1, t), We("FieldValue.increment", arguments, 1), 
        new _n(t);
    }, t.prototype.isEqual = function(t) {
        return this === t;
    }, t;
}(), "Use FieldValue.<field>() instead."), jr = Vr(ln, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), Gr = {
    Firestore: Sr,
    GeoPoint: bn,
    Timestamp: v,
    Blob: jr,
    ...
    Commit: "commit"
}, Jr = "gl-js/ fire/" + u, Hr = /** @class */ function() {
    function t(t) {
        this.ii = t.ii;
...
he.an(new (/** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "document", {
        ...
        return Promise.resolve(new Hr(t));
    }, t.prototype.g_ = function() {
        return zr.Gf() ? new zr : new Br;
...
}())), Xr(n), exports.__PRIVATE_registerFirestore = Xr;
